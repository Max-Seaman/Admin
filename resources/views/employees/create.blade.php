...
@section('content')
    <x-page-header>
        <a class="underline nav-link d-inline" href="{{ route('employees.index') }}">Employees</a> / Create
    </x-page-header>
            ...
            <div class="bg-custom-green p-5 rounded shadow-lg">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <x-form-input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control" />
                    ...
                    <div class="col-md-6">
                        ...
                        <x-form-input type="text" name="last_name" value="{{ old('last_name') }}" class="form-control" />
                    ...
                    <div class="col-md-6">
                        ...
                        <x-form-input type="text" name="phone" value="{{ old('phone') }}" class="form-control" />
